...
Route::group(array('prefix'=>'admin'),function(){
    ...
    */
    ...
    Route::get('/deleteuser/{id}', 'admin\DashboardController@adminuser_delete');
    ...
    Route::get('/usermessage', 'admin\DashboardUserController@user_messages');
    Route::any('/deletmessage/{mid}', 'admin\DashboardUserController@user_messages_delete');
});